...
const translations = {
  en: {
    ...
    statLocationSub: "Hidalgo County Sanctuary",
    statReviews: "5.0 ★★★★★",
    statReviewsSub: "From Our Loving Community",
    statFamily: "Family Focused",
    statFamilySub: "A Place for All Generations",
    statBilingual: "Bilingual Services",
    statBilingualSub: "English 10:00 AM | Spanish 11:30 AM",

    // Schedule Section
    schedSectionTag: "Weekly Gatherings",
    schedTitle: "Service & Prayer Schedule",
    schedDesc: "Experience the living presence of God in each of our gatherings at 10501 N Mayberry Rd, Mission, TX.",
    
    sunTitle: "Sunday Double Family Worship",
    sunTimeEn: "1st Service (English): 10:00 AM",
    sunTimeEs: "2nd Service (Spanish): 11:30 AM",
    sunDesc: "Spirit-filled praise and worship, empowering biblical preaching, and dedicated classes for children and youth.",
    
    wedTitle: "Wednesday Word & Discipleship",
    wedTime: "Wednesdays 7:00 PM – 8:30 PM",
    wedDesc: "Deep biblical study, spiritual empowerment, and mid-week recharge to strengthen your faith.",
    
    monTitle: "Monday Intercession & Prayer",
    monTime: "Mondays 7:00 PM – 8:00 PM",
    monDesc: "A dedicated hour of heartfelt prayer for our families, the sick, our community, and the nations.",
    ...
    pillar1Desc: "We foster an atmosphere where the Holy Spirit has full freedom to touch hearts and renew minds.",
    pillar2Title: "Theology & Leadership",
    pillar2Desc: "Deep biblical education through Universidad de Teología and practical mentoring in Academia de Líderes.",
    pillar3Title: "Sergios en Acción",
    pillar3Desc: "Faith shown in direct action: community outreach, benevolence, and loving service for families in need.",
    ...
    minTitle: "A Place to Flourish for the Entire Family",
    minSubtitle: "Discover where you and your family can connect, grow, and serve.",
    ...
    // Women's Ministry
    minWomenTitle: "Women's Ministry (Damas)",
    minWomenTag: "Women of Faith",
    minWomenDesc: "Empowering conferences, prayer circles, and spiritual retreats where women are touched and renewed by the Holy Spirit.",
    ...
    giveSubtitle: "“If it’s in your heart to donate, all donations are welcome.”",
    giveDesc: "Your generous tithes and offerings help expand God’s Kingdom, power our Universidad de Teología, support Sergios en Acción, and bless families throughout Hidalgo County.",
    giveCashAppTitle: "Cash App",
    giveCashAppDesc: "Instant giving via Cash App tag",
    giveCashAppTag: "$rocafuerte2016",
    ...
    vStep1Desc: "Come just as you are. Casual clothing or Sunday best are both welcome.",
    vStep2Title: "2. Accessible Location",
    vStep2Desc: "Conveniently located on Mayberry Rd in Mission with easy on-site parking.",
    vStep3Title: "3. Double Sunday Services",
    vStep3Desc: "Join us in English at 10:00 AM or Spanish at 11:30 AM with full kids ministry.",
    vStep4Title: "4. Welcoming Community",
    vStep4Desc: "Our family is ready to welcome you with open arms and answer any questions.",
    visitBannerText: "Join us this Sunday (10:00 AM English | 11:30 AM Spanish) or Wednesday at 7:00 PM. Have questions? Call us directly!",
    ...
    test4Text: "“A tremendous blessing for our youth and leadership students. Teaching and serving the Lord with honor and faith.”",
    test4Author: "Chaplain Samuel Balleza",
    test4Role: "Ministerial Alliance",

    // Contact & Location Section
    contactSectionTag: "Location & Contact",
    contactTitle: "Connect with Our Church",
    contactSubtitle: "Visit our sanctuary in Mission, TX or call our leadership team directly.",
    
    locChurchTitle: "Sanctuary & Campus",
    locChurchAddr: "10501 N Mayberry Rd, Mission, TX 78573",
    locChurchHours: "Sun: 10:00 AM (EN) & 11:30 AM (ES) | Wed: 7:00 PM | Mon: 7:00 PM",
    
    contactLeadersTitle: "Direct Leadership Phone Directory",
    contactRoleIvan: "Youth & Ministry",
    contactRoleNancy: "Youth Leadership",
    ...
    adminPassIncorrect: "Incorrect password. Please try again.",
    adminUploadHeader: "Live Church Photo Manager",
    adminUploadSub: "Upload or swap photos. Changes reflect live on the website immediately.",
    adminHeroPhoto: "Hero Worship Photo",
    adminPastorPhoto: "Pastoral Team Photo",
    adminYouthPhoto: "Youth Ministry Photo",
    adminDamasPhoto: "Women's Ministry Photo",
    adminCongregationPhoto: "Congregation / About Photo",
    adminSaveBtn: "Save & Apply Changes",
    adminResetBtn: "Reset to Originals",

    // Footer
    footerTagline: "Built upon the Mighty Rock of Jesus Christ.",
  ...
  es: {
    ...
    statLocationSub: "Templo en Condado de Hidalgo",
    statReviews: "5.0 ★★★★★",
    statReviewsSub: "Testimonios de Nuestra Comunidad",
    statFamily: "Enfoque Familiar",
    statFamilySub: "Un Lugar para Todas las Edades",
    statBilingual: "Servicios Bilingües",
    statBilingualSub: "Inglés 10:00 AM | Español 11:30 AM",

    // Schedule Section
    schedSectionTag: "Reuniones Semanales",
    schedTitle: "Horarios de Servicios y Oración",
    schedDesc: "Ven a tener un encuentro personal con el Espíritu Santo en cada uno de nuestros servicios en 10501 N Mayberry Rd.",
    
    sunTitle: "Doble Servicio Familiar de Domingo",
    sunTimeEn: "1er Servicio (Inglés): 10:00 AM",
    sunTimeEs: "2do Servicio (Español): 11:30 AM",
    sunDesc: "Alabanza y adoración ungida, predicación profunda de la Palabra de Dios y clases para niños y jóvenes.",
    
    wedTitle: "Noche de Palabra y Discipulado",
    wedTime: "Miércoles 7:00 PM – 8:30 PM",
    wedDesc: "Estudio bíblico dinámico, edificación espiritual y oración para fortalecer tu fe en medio de la semana.",
    
    monTitle: "Lunes de Clamor e Intercesión",
    monTime: "Lunes 7:00 PM – 8:00 PM",
    monDesc: "Un tiempo dedicado a la oración ferviente por los enfermos, las familias, la iglesia y nuestra comunidad.",
    ...
    pillar1Desc: "Creemos en crear una atmósfera donde el Espíritu Santo tenga total libertad para tocar y transformar corazones.",
    pillar2Title: "Teología y Liderazgo",
    pillar2Desc: "Educación bíblica profunda con la Universidad de Teología y mentoría práctica en la Academia de Líderes.",
    pillar3Title: "Sergios en Acción",
    pillar3Desc: "Amor demostrado en hechos: obras de compasión, entrega de despensas y apoyo directo a familias vulnerables.",
    ...
    // Women's Ministry
    minWomenTitle: "Ministerio de Damas",
    minWomenTag: "Mujeres de Fe",
    minWomenDesc: "Conferencias gloriosas para mujeres, retiros espirituales y círculos de oración donde Dios renueva fuerzas y sana corazones.",
    ...
    giveTitle: "Apoya la Obra de Dios",
    giveSubtitle: "«Si está en tu corazón sembrar, toda donación es bienvenida.»",
    giveDesc: "Tus diezmos y ofrendas voluntarias impulsan el Evangelio, sostienen nuestra Universidad de Teología, respaldan a Sergios en Acción y bendicen a cientos de familias.",
    giveCashAppTitle: "Cash App",
    giveCashAppDesc: "Ofrenda instantánea con el usuario Cash App",
    giveCashAppTag: "$rocafuerte2016",
    giveZelleTitle: "Zelle",
    ...
    vStep1Desc: "Ven tal como eres. Ropa casual o atuendos de domingo, lo importante es tu corazón.",
    vStep2Title: "2. Ubicación Accesible",
    vStep2Desc: "Convenientemente ubicados sobre Mayberry Rd en Mission con estacionamiento fácil.",
    vStep3Title: "3. Doble Servicio Dominical",
    vStep3Desc: "Acompáñanos en Inglés a las 10:00 AM o en Español a las 11:30 AM con clases infantiles.",
    vStep4Title: "4. Ambiente Acogedor",
    vStep4Desc: "Nuestra comunidad te recibirá con una sonrisa fraternal y los brazos abiertos.",
    visitBannerText: "Acompáñanos este Domingo (10:00 AM Inglés | 11:30 AM Español) o Miércoles a las 7:00 PM. ¿Preguntas? ¡Llámanos!",
    ...
    test4Text: "«Una bendición total para nuestra juventud y los estudiantes de liderazgo. Instruyendo con honor y fe.»",
    test4Author: "Capellán Samuel Balleza",
    test4Role: "Alianza Ministerial",

    // Contact & Location Section
    contactSectionTag: "Ubicación & Contacto",
    contactTitle: "Conéctate con Nuestra Casa",
    contactSubtitle: "Visítanos en Mission o llámanos directamente.",
    
    locChurchTitle: "Santuario y Templo",
    locChurchAddr: "10501 N Mayberry Rd, Mission, TX 78573",
    locChurchHours: "Dom: 10:00 AM (EN) & 11:30 AM (ES) | Mié: 7:00 PM | Lun: 7:00 PM",
    
    contactLeadersTitle: "Directorio Telefónico de Líderes",
    contactRoleIvan: "Jóvenes y Ministerio",
    contactRoleNancy: "Liderazgo Juvenil",
    ...
    adminPassIncorrect: "Contraseña incorrecta. Inténtelo de nuevo.",
    adminUploadHeader: "Gestor de Fotos en Vivo",
    adminUploadSub: "Sube o cambia fotos directamente. Los cambios se aplicarán inmediatamente.",
    adminHeroPhoto: "Foto Principal de Alabanza (Hero)",
    adminPastorPhoto: "Foto del Equipo Pastoral",
    adminYouthPhoto: "Foto de Jóvenes",
    adminDamasPhoto: "Foto de Damas",
    adminCongregationPhoto: "Foto de Congregación / Nosotros",
    adminSaveBtn: "Guardar y Aplicar Cambios",
    adminResetBtn: "Restablecer Originales",

    // Footer
    footerTagline: "Construidos sobre la Roca Inconmovible de Jesucristo.",
